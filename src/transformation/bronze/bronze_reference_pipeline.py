...
@dp.table(
    name=f"{CATALOG}.{BRONZE_SCHEMA}.bronze_airports_raw",
...
@dp.table(
    name=f"{CATALOG}.{BRONZE_SCHEMA}.bronze_airlines_raw",
...
@dp.table(
    name=f"{CATALOG}.{BRONZE_SCHEMA}.bronze_aircraft_raw",
...
@dp.table(
    name=f"{CATALOG}.{BRONZE_SCHEMA}.bronze_cities_raw",
...
@dp.table(
    name=f"{CATALOG}.{BRONZE_SCHEMA}.bronze_countries_raw",
